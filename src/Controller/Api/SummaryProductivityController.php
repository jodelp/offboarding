...
class SummaryProductivityController extends AppController
{
    ...
    private $summaryProductivitiesTable;
      ...
      /**
       * @api {post} /api/summary_productivity.json Summary productivity of staff
    ...
    public function add()
    {
        ...
        $end = $this->getEndDate();
        $summary = $this->summaryProductivitiesTable->computeSummary($staff, $start, $end);
        ...
        if ($this->summaryProductivitiesTable->save($summary)) {
            ...
            $client = $clientsTable->get($summary['client_id']);
            $data = [
