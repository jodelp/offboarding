...
/**
* Adding the version build configs
*/
if (file_exists(CONFIG . '.version')) {
    $versionEnv = new \josegonzalez\Dotenv\Loader([CONFIG . '.version']);
    $versionEnv->parse()
        ->putenv()
        ->toEnv()
        ->toServer();
...
# Gearman Host
define('GEARMAN_HOST', '172.17.0.4');

# Client Microservice URL
define('CLIENT_MS_URL', 'http://172.17.0.6/api/');
