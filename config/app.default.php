...
return [
    ...
    'App' => [
        ...
        'applicationSalt' => 'a160226b9aa1490aab4c2cbTiMdb0eddf24b98796aefdc884bdcbb67b0498e6340bxsD12w'
    ],
    ...
    'Cache' => [
        ...
        /**
         * Cache config for storing short live cache
         */
        'cache_short' => [
            'className' => 'File',
            'duration' => '+1 days',
    ...
    'Datasources' => [
        ...
        /**
         * Mystaff connection TO BE REMOVE ONCE WERE DONE WITH ALL DATA MIGRATION
         */
        'mystaff' => [
            'className' => Connection::class,
            'driver' => Mysql::class,
            ...
            'quoteIdentifiers' => false,
            'log' => false,
            'url' => 'mysql://<username>:<password>@<host-ip-address>/<database_name>?encoding=utf8&timezone=UTC&cacheMetadata=true&quoteIdentifiers=false&persistent=false',
        ],
    ],
    ...
    'Log' => [
        ...
        'migrationTaskCategories' => [
            ...
            'path' => LOGS,
            'levels' => [],
            'scopes' => ['migrationTaskCategories'],
