...
/**
 * SystemStaffPartialsFixture
 */
class SystemStaffPartialsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'status' => ['type' => 'string', 'length' => 25, 'null' => true, 'default' => null, 'collate' => 'ascii_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
